...
def myNetwork():
    ...
    info( '*** Add hosts\n')
    h5 = net.addHost('h5', cls=Host, ip='33.0.0.1', defaultRoute=None)
    h6 = net.addHost('h6', cls=Host, ip='43.0.0.1', defaultRoute=None)
    h1 = net.addHost('h1', cls=Host, ip='23.0.0.1', defaultRoute=None)
    h2 = net.addHost('h2', cls=Host, ip='23.0.0.2', defaultRoute=None)
    h3 = net.addHost('h3', cls=Host, ip='23.0.0.3', defaultRoute=None)
    h4 = net.addHost('h4', cls=Host, ip='53.0.0.1', defaultRoute=None)
