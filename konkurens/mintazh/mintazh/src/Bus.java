...
public class Bus {
    ...
    private static BlockingQueue<Attendee> queue = new LinkedBlockingQueue<>(LIMIT);
    ...
    private static AtomicBoolean isTakingPassengers = new AtomicBoolean(false);
    ...
    public void startBus(){
        while(true){
            ...
            System.out.println("Bus is now taking " + LIMIT + " passengers");
            ...
            System.out.println("Bus is going to drop passengers off");
            ...
            if (queue.isEmpty()){
                ...
                while (!queue.isEmpty()){
                   try {
                       System.out.println(queue.take().getName() + "got off the bus, going home");
                   } catch (InterruptedException e) {
                       e.printStackTrace();
                   }
...
//          System.out.println("The bus is not taking passengers currently");
        ...
        boolean success = queue.offer(attendee);
